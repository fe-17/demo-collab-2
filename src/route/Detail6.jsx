...
import logo from "../assets/yp.jpg";
            ...
            <div className="container bg-teal-400 w-11/12 ml-16 mr-14"> 
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full self-center px-4 lg:w-1/2">
                        ...
                        <a href='https://wa.me/+622178842580' className="text-base font-semibold text-black bg-white py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out ">Jadwalkan Konsultasi</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className=" px-4">
                    <div className="max-w-xl mx-auto text-center mb-19 mt-10">
                        <div className="block p-10 bg-white rounded-lg w-150 h-300" >
                            ...
                            <p className="font-normal text-gray-700 dark:text-gray-400">Pulih, dalam upayanya memberikan layanan yang baik kepada masyarakat telah mengalami beberapa kali perkembangan dan perubahan. Pada suatu masa Pulih telah berkembang menjadi sebuah lembaga dengan sebuah kantor Pusat di Jakarta untuk memberikan layanan langsung kepada korban kekerasan maupun memberikan dukungan kepada program-program penguatan masyarakat di beberapa wilayah.
                            Kantor Pusat Pulih didukung oleh kantor Area Aceh–untuk memberikan penguatan psikososial kepada korban Gempa dan Tsunami Aceh, Kantor Area Ambon–untuk memberikan penguatan psikososial kepada remaja korban konflik antar agama, dan Kantor Area di Jakarta untuk pengungsi (Urban Refuges Project)–memberikan penguatan dan pendampingan psikososial kepada para pengungsi internasional di sekitar Jakarta.
                            Namun, menjelang ulang tahun Yayasan Pulih ke 15 di tahun 2017, dalam upaya semakin meluaskan layanan kepada masyarakat, Pulih memutuskan untuk mendirikan 3 kantor mandiri dengan kekhususan dan area kerja yang berbeda dan beragam.</p>
                        </div>
                    </div>
                </div>
            </div>
                      ...
                      <table className="w-full text-left">
                          <tbody>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Konsultasi Online</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Konsultasi offline</td>
                              </tr>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Psikolog Profesional</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Pelatihan</td>
                              </tr>
                  ...
                  <div className="overflow-x-auto relative">
                      <table className="w-full text-lg text-left text-gray-500 rounded-lg border-black">
                          <tbody className=''>
                              ...
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 whitespace-nowrap">
                                    <a href="https://wa.me/+622178842580" className="w-12 h-12 mr-5 rounded-full flex justify-center items-center border border-slate-300 hover:border-green-400 hover:bg-green-400 hover:text-white text-slate-300"> 
                                  ...
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">+622178842580</td>
                              </tr>
                              <tr className="bg-transparent">
                                  ...
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">pulihfoundation@gmail.com</td>
                              </tr>                               
                          </tbody>
                      </table> 
                  </div>
