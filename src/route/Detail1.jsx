...
import rsbintaro from "../assets/rs-eka.jpg";
  ...
  return (
    <div className=''>
                ...
                <div className="flex flex-wrap">
                    <div className="w-full self-end px-4 lg:w-1/2">
                        <div className="relative mt-10 lg:mt-9 lg:right-0 ml-5">
                            <img src={rsbintaro} alt="rsbintaro" className="mb-10 mt-10 max-w-xs bg-white rounded-2xl " />
                        </div>
                    </div>
                    ...
                    <h1
                        ...
                        >Eka Hospital BSD 🏥</span>
                    </h1>
                    <h2 className="font-medium text-slate-500 text-lg  lg:text-2xl">
                        Bisnis Central Business District Lot IX, 
                    </h2>
                    ...
                    <a href='tel:02125655555' className="text-base font-semibold text-black bg-white py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out ">Jadwalkan Konsultasi</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className=" px-4">
                    <div className="max-w-xl mx-auto text-center mb-19 mt-10">
                        <div className="block p-10 bg-white rounded-lg w-150 h-300" >
                            ...
                            <p className="font-normal text-gray-700 dark:text-gray-400">Eka Hospital di Bumi Serpong Damai (BSD - Tangerang) adalah rumah sakit swasta umum yang berkomitmen memberikan pelayanan kesehatan berkualitas dari staf berdedikasi dan profesional, didukung teknologi terkini dan standar fasilitas kesehatan tinggi.Eka Hospital BSD telah meraih akreditasi internasional oleh Joint Commission International (JCI) sejak 2010. JCI adalah organisasi nirlaba berpusat di Amerika Serikat yang berdedikasi untuk terus meningkatkan standar keselamatan & kualitas layanan kesehatan tingkat internasional. Pada waktu itu Eka Hospital BSD merupakan rumah sakit internasional termuda di Indonesia, yang mencapai prestasi dalam 2 tahun masa beroperasi saja.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="grid sm:grid-cols-2  lg:grid-cols-2">
          <div>
              <div className="block p-6 bg-teal-400 rounded-2xl mx-10 mt-10 text-center h-96" >
                      ...
                      <table className="w-full text-left">
                          <tbody>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Ruang Tunggu</th>
                              ...
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Mushola</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Instalasi Rawat Jalan</td>
                              </tr>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Unit Gawat Darurat(UGD)</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Instalasi Tumbuh Kembang anak</td>
                              </tr>
                          </tbody>
                      </table>  
                  </div>
          ...
          <div>
              <div className="block p-6 bg-teal-400 rounded-2xl mr-10 ml-10 mt-10 h-96" >
                  ...
                  <div className="overflow-x-auto relative">
                      <table className="w-full text-left text-gray-500 rounded-lg border-black">
                          <tbody className=''>
                              <tr className="bg-transparent">
                                  ...
                                  <td className="py-4 px-6 font-medium whitespace-nowrap text-black">- </td>
                              </tr>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 whitespace-nowrap">
                                    <a href='tel:02125655555' className="w-12 h-12 mr-5 rounded-full flex justify-center items-center border border-slate-300 hover:border-green-400 hover:bg-green-400 hover:text-white text-slate-300">
                                  ...
                                  <td className="py-4 px-6 font-medium whitespace-nowrap text-black">02125655555</td>
                              </tr>
                              <tr className="bg-transparent">
