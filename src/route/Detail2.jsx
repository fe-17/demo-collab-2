...
import logo from "../assets/rs-bintaro.jpg";
                ...
                <div className="flex flex-wrap">
                    <div className="w-full self-end px-4 lg:w-1/2">
                        <div className="relative mt-10 lg:mt-9 lg:right-0 ml-5">
                            <img src={logo} alt="logo" className="mb-10 max-w-xs  mt-10 bg-white rounded-2xl " />
                        </div>
                    </div>
                    <div className="w-full self-center px-4 lg:w-1/2">
                        <h1
                            ...
                            >RS Premier Bintaro 🏥</span>
                        </h1>
                        <h2 className="font-medium text-slate-500 text-lg  lg:text-2xl">
                            Jl. Moh. Husni Thamrin No.1, Pd. Jaya, Kec. Pd. Aren, 
                        </h2>
                        ...
                        <a href='tel:02127625500' className="text-base font-semibold text-black bg-white py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out ">Jadwalkan Konsultasi</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className=" px-4">
                    <div className="max-w-xl mx-auto text-center mb-19 mt-10">
                        <div className="block p-10 bg-white rounded-lg w-150 h-300" >
                            ...
                            <p className="font-normal text-gray-700 dark:text-gray-400">Rumah Sakit Premier Bintaro merupakan Rumah Sakit Umum Swasta yang berdiri sejak tanggal 12 Agustus 1998 dibawah naungan Ramsay Sime Darby Health Care Group. Rumah Sakit Premier Bintaro memiliki Visi mewujudkan pelayanan kesehatan yang terkemuka di Asia dengan layanan kesehatan yang berkualitas. Dengan Misi memberikan pelayanan kesehatan yang berkualitas dan memuaskan pasien serta mencapai kinerja pelayanan yang diinginkan.</p>
                        </div>
                    </div>
                </div>
            </div>
                      ...
                      <table className="w-full text-left">
                          <tbody>
                              <tr className="bg-transparent">
                                  ...
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Instalasi Bersalin</td>
                              </tr>
                              <tr className="bg-transparent">
                              ...
                              <tr className="bg-transparent">
                                  ...
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Instalasi Gawat Darurat</td>
                              </tr> 
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Instalasi radiologi</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Kafetaria</td>
                              </tr>
                              <tr className="bg-transparent">
                  ...
                  <div className="overflow-x-auto relative">
                      <table className="w-full text-lg text-left text-gray-500 rounded-lg border-black">
                          <tbody className=''>
                              ...
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 whitespace-nowrap">
                                    <a href="tel:02127625500" className="w-12 h-12 mr-5 rounded-full flex justify-center items-center border border-slate-300 hover:border-green-400 hover:bg-green-400 hover:text-white text-slate-300"> 
                                  ...
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">02127625500</td>
                              </tr>
                              <tr className="bg-transparent">
