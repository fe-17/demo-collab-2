...
import logo from "../assets/rs-brawijaya.jpg";
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full self-center px-4 lg:w-1/2">
                        <h1
                            ...
                            >RSIA Brawijaya Duren Tiga 🏥</span>
                        </h1>
                        ...
                        <a href='tel:02150806438' className="text-base font-semibold text-black bg-white py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out ">Jadwalkan Konsultasi</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className=" px-4">
                    <div className="max-w-xl mx-auto text-center mb-19 mt-10">
                        <div className="block p-10 bg-white rounded-lg w-150 h-300" >
                            ...
                            <p className="font-normal text-gray-700 dark:text-gray-400">Rumah sakit ibu dan anak yang berlokasi di pusat ibukota Jakarta. Terletak di daerah Pancoran yang sangat strategis. Brawijaya Hospital Duren Tiga senantiasa megutamakan kenyamanan dan kepuasan pasien dengan layanan yang prima, dan tepat waktu. Tidak hanya melayani Ibu dan anak, Brawijaya Hospital Duren Tiga juga melayani Medical Check Up (MCU) untuk pribadi, keluarga dan juga Peusahaan.</p>
                        </div>
                    </div>
                </div>
            </div>
                      ...
                      <table className="w-full text-left">
                          <tbody>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Ambulans</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Unit Perawatan Intensif</td>
                              </tr>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Farmasi</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Medical Check Up</td>
                              </tr>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Paediatric Intensive Care Unit (PICU)</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Instalasi RLaboratorium</td>
                              </tr> 
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Neonate Intensive Care Unit (NICU)</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Instalasi Kafetaria</td>
                              </tr>
                          </tbody>
                      </table>  
                  </div>
                  ...
                  <div className="overflow-x-auto relative">
                      <table className="w-full text-lg text-left text-gray-500 rounded-lg border-black">
                          <tbody className=''>
                              ...
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 whitespace-nowrap">
                                    <a href="/#" className="w-12 h-12 mr-5 rounded-full flex justify-center items-center border border-slate-300 hover:border-green-400 hover:bg-green-400 hover:text-white text-slate-300"> 
                                  ...
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">02150806438</td>
                              </tr>
                              <tr className="bg-transparent">
