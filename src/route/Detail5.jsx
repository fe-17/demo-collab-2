...
import logo from "../assets/ypp1.svg";
                ...
                <div className="flex flex-wrap">
                    <div className="w-full self-end px-4 lg:w-1/2">
                        <div className="relative mt-10 lg:mt-9 lg:right-0 ml-5">
                            <img src={logo} alt="logo" className="mb-10 max-w-sm mt-10 bg-white rounded-2xl " />
                        </div>
                    </div>
                    <div className="w-full self-center px-4 lg:w-1/2">
                        <h1
                            ...
                            >Yayasan Praktek Psikolog Indonesia PIK 🏥</span>
                        </h1>
                        <h2 className="font-medium text-slate-500 text-lg  lg:text-2xl">
                            Infiniti Office, Arcade Business Center 6th Floor Unit 6, Jl. Pantai Indah Utara 2 Kav. C1, PIK, Kec. Penjaringan,  
                        </h2>
                        ...
                        <a href='tel:02127563512' className="text-base font-semibold text-black bg-white py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out ">Jadwalkan Konsultasi</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className=" px-4">
                    <div className="max-w-xl mx-auto text-center mb-19 mt-10">
                        <div className="block p-10 bg-white rounded-lg w-150 h-300" >
                            ...
                            <p className="font-normal text-gray-700 dark:text-gray-400">Yayasan Praktek Psikolog Indonesia (YPPI) merupakan organisasi jasa praktek psikolog profesional yang terdiri dari para associated psikolog yang didirikan pada tanggal 10 Februari 2012 . Tim YPPI terdiri dari psikolog yang siap memberikan bantuan dalam penanganan masalah dan pengembangan sumber daya manusia atas dasar latar belakang pemikiran berikut ini : Pada anak-anak kadang terjadi gangguan perkembangan seperti autisme, ADHD, kesulitan belajar atau anak menampilkan perilaku yang tidak tepat, sehingga mereka tidak bisa bertumbuh kembang secara optimal. Dengan visi Menjadi lembaga praktek psikolog terdepan dalam memberikan pelayanan jasa psikologi kepada masyarakat demi tercapainya manusia yang sehat secara psikologis, lahir, dan batin, YPPI juga memiliki misi antara lain : Memberikan jasa pemeriksaan psikologis berupa tes IQ, tes minat & bakat, tes kepribadian, gaya belajar, tes kecerdasan majemuk, tes kecerdasan emosi, dan tes kecerdasan spiritual. Memberikan jasa konseling, training, & intervensi psikologi. Memberikan jasa pemberdayaan masyarakat dengan pendekatan psikologi. Memberikan jasa psikolog sekolah, psikolog perusahaan, dan psikolog sosial. Memberikan jasa rekrutmen karyawan, analisis jabatan, performance appraisal, & outsource</p>
                        </div>
                    </div>
                </div>
            </div>
                      ...
                      <table className="w-full text-left">
                          <tbody>
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 font-normal whitespace-nowrap text-black">• Area Parkir</th>
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">• Ruang Tunggu</td>
                              </tr>
                  ...
                  <div className="overflow-x-auto relative">
                      <table className="w-full text-lg text-left text-gray-500 rounded-lg border-black">
                          <tbody className=''>
                              ...
                              <tr className="bg-transparent">
                                  <th scope="row" className="py-4 px-6 whitespace-nowrap">
                                    <a href="tel:02127563512"  className="w-12 h-12 mr-5 rounded-full flex justify-center items-center border border-slate-300 hover:border-green-400 hover:bg-green-400 hover:text-white text-slate-300"> 
                                  ...
                                  <td className="py-4 px-6 font-normal whitespace-nowrap text-black">02127563512</td>
                              </tr>
                              <tr className="bg-transparent">
