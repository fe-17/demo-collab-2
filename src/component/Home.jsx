    ...
    <>
      ...
      <div className="flex flex-wrap">
        <div className="w-full self-center px-20 lg:w-1/2">
          ...
          <Link to={"/layanan"} class="text-sm font-semibold text-white bg-secondary py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">
            Jadwalkan Konsultasi
          </Link>
        </div>
        <div className="w-full self-end lg:right-0 lg:w-1/2">
          <div className="relative mt-10 lg:mt-6">
            <img width="420" height="420" src={Landing} alt="Gambar" className="max-w-full mx-auto lg:mx-44" />
          </div>
        </div>
      </div>
    </>
